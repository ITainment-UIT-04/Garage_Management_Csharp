...
USE QUANLIGARA
GO
INSERT INTO PHUTUNG(TenVTPT, SoLuongTon, DonGia) VALUES
(N'Phuộc trước','97','780000'),
(N'Phuộc sau','80','530000'),
(N'Mâm ép','42','2000000'),
(N'Bố ly hợp','85','1950000'),
(N'Bố thắng trước','84','1300000'),
(N'Bố thắng sau','48','1050000'),
(N'Cao su chân máy','0','750000'),
(N'Rotuyn lái trong','76','700000'),
(N'Máy phát điện','23','7300000'),
(N'Đồng hồ taplo innova G','76','240000'),
(N'Đồng hồ taplo innova J','26','8500000'),
(N'Cảm biến ABS','30','2800000'),
(N'Lốc lạnh','50','4500000'),
(N'Quạt dàn lạnh','63','1250000'),
(N'Dàn lạnh','10','2500000'),
(N'Dàn lạnh sau','68','2200000'),
(N'Dàn nóng','52','4500000'),
(N'Van tiết lưu','62','400000'),
(N'Đèn pha','85','4100000'),
(N'Đèn lái','89','1100000'),
(N'Đèn cản','71','1200000'),
(N'Cản trước','25','1200000'),
(N'Cửa xe','5','7100000'),
(N'Kính chiếu hậu','8','3200000'),
(N'Đuôi cá Honda Civic','53','2200000'),
(N'Sét gạt mưa Honda Civic','97','460000'),
(N'Lọc gió động cơ Honda Civic','78','260000'),
(N'Lọc gió','80','1200000'),
(N'Lọc nhiên liệu','34','170000'),
(N'Láp ngang cầu sau','20','7100000'),
(N'Láp dọc đồng bộ','34','20500000'),
(N'Cao su chân máy trước','54','900000'),
(N'Mâm ép','33','6900000'),
(N'Búp sen thắng sau','25','700000'),
(N'Ắc quy','57','1970000'),
(N'Ba đờ sốc trước','63','1170000'),
(N'Lọc nhớt động cơ','34','120000'),
(N'Lọc nhớt nhiên liệu','73','170000'),
(N'Bộ giảm chấn','8','3750000'),
(N'Bạc đạn bánh xe','62','160000'),
(N'Bạc đạn trong trục','10','130000'),
(N'Gương chiếu hậu','80','320000'),
(N'Đèn pha trước','34','1320000'),
(N'Đèn hậu','61','480000'),
(N'Dây đai trợ lực lái','20','350000'),
(N'Bộ bạc đạn ly hợp','94','220000'),
(N'Đĩa bộ ly hợp','0','760000'),
(N'Bạc thanh truyền dưới','19','370000'),
(N'Kính chắn gió','50','1200000'),
(N'Kính chắn gió (loại bảo mật)','15','1600000')
